...
Config.LevelTwo = 2 -- How much garbage do you need to collect to get to level 2
Config.LevelThree = 2 -- How much garbage do you need to collect to get to level 3
--Config.LevelFour = 4
--Config.LevelFive = 4
--Config.LevelSix = 6
...
Config.LevelOneAmount = 200
Config.LevelTwoAmount = 400
Config.LevelMaxAmount = 500
--Config.LevelFourAmount = 400
--Config.LevelFiveAmount = 500
--Config.LevelMaxAmount = 600
