...
document.onkeyup = function (data) {
    if (data.which == 27) {
        $.post('https://advanced-garbagejob/advanced-garbagejob:CloseMenu');
        $('#locker-menu').hide();
        $('#vehicles').hide();
        return
    }
...
$('.sign-in').click(function() {
    $.post('https://advanced-garbagejob/advanced-garbagejob:SetOnDuty');
    $.post('https://advanced-garbagejob/advanced-garbagejob:CloseMenu');
    $('#locker-menu').hide();
});

$('.sign-out').click(function() {
    $.post('https://advanced-garbagejob/advanced-garbagejob:SetOffDuty');
    $.post('https://advanced-garbagejob/advanced-garbagejob:CloseMenu');
    $('#locker-menu').hide();
    $('#collections').hide();
});
...
$('.vehicle1').click(function() {
    $.post('https://advanced-garbagejob/advanced-garbagejob:SpawnJobVehicle', JSON.stringify('vehicle1'));
    $.post('https://advanced-garbagejob/advanced-garbagejob:CloseMenu');
    $('#vehicles').hide();
});

$('.vehicle2').click(function() {
    $.post('https://advanced-garbagejob/advanced-garbagejob:SpawnJobVehicle', JSON.stringify('vehicle2'));
    $.post('https://advanced-garbagejob/advanced-garbagejob:CloseMenu');
    $('#vehicles').hide();
});